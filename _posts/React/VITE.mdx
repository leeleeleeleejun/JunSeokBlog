...
> 소스 코드를 업데이트 하게 되면 번들링 과정을 다시 거쳐야 했었다. 따라서 서비스가 커질수록 소스 코드 갱신 시간 또한 선형적으로 증가하게 되었습니다.
> 이러한 불편함으로 Vite를 사용을 하게 되었습니다.

### Vite란

> Vite는 현대적인 웹 개발을 위한 빠르고 경량화된 빌드 도구로서, 개발 서버에서 주로 사용되는 요소 중 하나가 Esbuild입니다.
> Esbuild는 기존 번들러와 달리 자바스크립트(javascript)가 아니라 go언어로 작성이 되었습니다.
>
> #### 개발서버 구동
>
